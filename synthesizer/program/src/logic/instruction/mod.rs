...
impl<N: Network> InstructionTrait<N> for Instruction<N> {
    ...
    fn to_json(&self) -> serde_json::Value {
        let j_vtype = match self {
            Instruction::Abs(_) => "Abs",
            Instruction::AbsWrapped(_) => "AbsWrapped",
            Instruction::Add(_) => "Add",
            Instruction::AddWrapped(_) => "AddWrapped",
            Instruction::And(_) => "And",
            Instruction::AssertEq(_) => "AssertEq",
            Instruction::AssertNeq(_) => "AssertNeq",
            Instruction::Async(_) => "Async",
            Instruction::Call(_) => "Call",
            Instruction::Cast(_) => "Cast",
            Instruction::CastLossy(_) => "CastLossy",
            Instruction::CommitBHP256(_) => "CommitBHP256",
            Instruction::CommitBHP512(_) => "CommitBHP512",
            Instruction::CommitBHP768(_) => "CommitBHP768",
            Instruction::CommitBHP1024(_) => "CommitBHP1024",
            Instruction::CommitPED64(_) => "CommitPED64",
            Instruction::CommitPED128(_) => "CommitPED128",
            Instruction::Div(_) => "Div",
            Instruction::DivWrapped(_) => "DivWrapped",
            Instruction::Double(_) => "Double",
            Instruction::GreaterThan(_) => "GreaterThan",
            Instruction::GreaterThanOrEqual(_) => "GreaterThanOrEqual",
            Instruction::HashBHP256(_) => "HashBHP256",
            Instruction::HashBHP512(_) => "HashBHP512",
            Instruction::HashBHP768(_) => "HashBHP768",
            Instruction::HashBHP1024(_) => "HashBHP1024",
            Instruction::HashKeccak256(_) => "HashKeccak256",
            Instruction::HashKeccak384(_) => "HashKeccak384",
            Instruction::HashKeccak512(_) => "HashKeccak512",
            Instruction::HashPED64(_) => "HashPED64",
            Instruction::HashPED128(_) => "HashPED128",
            Instruction::HashPSD2(_) => "HashPSD2",
            Instruction::HashPSD4(_) => "HashPSD4",
            Instruction::HashPSD8(_) => "HashPSD8",
            Instruction::HashSha3_256(_) => "HashSha3_256",
            Instruction::HashSha3_384(_) => "HashSha3_384",
            Instruction::HashSha3_512(_) => "HashSha3_512",
            Instruction::HashManyPSD2(_) => "HashManyPSD2",
            Instruction::HashManyPSD4(_) => "HashManyPSD4",
            Instruction::HashManyPSD8(_) => "HashManyPSD8",
            Instruction::Inv(_) => "Inv",
            Instruction::IsEq(_) => "IsEq",
            Instruction::IsNeq(_) => "IsNeq",
            Instruction::LessThan(_) => "LessThan",
            Instruction::LessThanOrEqual(_) => "LessThanOrEqual",
            Instruction::Modulo(_) => "Modulo",
            Instruction::Mul(_) => "Mul",
            Instruction::MulWrapped(_) => "MulWrapped",
            Instruction::Nand(_) => "Nand",
            Instruction::Neg(_) => "Neg",
            Instruction::Nor(_) => "Nor",
            Instruction::Not(_) => "Not",
            Instruction::Or(_) => "Or",
            Instruction::Pow(_) => "Pow",
            Instruction::PowWrapped(_) => "PowWrapped",
            Instruction::Rem(_) => "Rem",
            Instruction::RemWrapped(_) => "RemWrapped",
            Instruction::Shl(_) => "Shl",
            Instruction::ShlWrapped(_) => "ShlWrapped",
            Instruction::Shr(_) => "Shr",
            Instruction::ShrWrapped(_) => "ShrWrapped",
            Instruction::SignVerify(_) => "SignVerify",
            Instruction::Square(_) => "Square",
            Instruction::SquareRoot(_) => "SquareRoot",
            Instruction::Sub(_) => "Sub",
            Instruction::SubWrapped(_) => "SubWrapped",
            Instruction::Ternary(_) => "Ternary",
