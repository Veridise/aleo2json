...
impl<N: Network> InstructionTrait<N> for Instruction<N> {
    ...
    fn to_json(&self) -> serde_json::Value {
        let j_vtype = match self {
            Instruction::Abs(instruction) => "Abs",
            Instruction::AbsWrapped(instruction) => "AbsWrapped",
            Instruction::Add(instruction) => "Add",
            Instruction::AddWrapped(instruction) => "AddWrapped",
            Instruction::And(instruction) => "And",
            Instruction::AssertEq(instruction) => "AssertEq",
            Instruction::AssertNeq(instruction) => "AssertNeq",
            Instruction::Async(instruction) => "Async",
            Instruction::Call(instruction) => "Call",
            Instruction::Cast(instruction) => "Cast",
            Instruction::CastLossy(instruction) => "CastLossy",
            Instruction::CommitBHP256(instruction) => "CommitBHP256",
            Instruction::CommitBHP512(instruction) => "CommitBHP512",
            Instruction::CommitBHP768(instruction) => "CommitBHP768",
            Instruction::CommitBHP1024(instruction) => "CommitBHP1024",
            Instruction::CommitPED64(instruction) => "CommitPED64",
            Instruction::CommitPED128(instruction) => "CommitPED128",
            Instruction::Div(instruction) => "Div",
            Instruction::DivWrapped(instruction) => "DivWrapped",
            Instruction::Double(instruction) => "Double",
            Instruction::GreaterThan(instruction) => "GreaterThan",
            Instruction::GreaterThanOrEqual(instruction) => "GreaterThanOrEqual",
            Instruction::HashBHP256(instruction) => "HashBHP256",
            Instruction::HashBHP512(instruction) => "HashBHP512",
            Instruction::HashBHP768(instruction) => "HashBHP768",
            Instruction::HashBHP1024(instruction) => "HashBHP1024",
            Instruction::HashKeccak256(instruction) => "HashKeccak256",
            Instruction::HashKeccak384(instruction) => "HashKeccak384",
            Instruction::HashKeccak512(instruction) => "HashKeccak512",
            Instruction::HashPED64(instruction) => "HashPED64",
            Instruction::HashPED128(instruction) => "HashPED128",
            Instruction::HashPSD2(instruction) => "HashPSD2",
            Instruction::HashPSD4(instruction) => "HashPSD4",
            Instruction::HashPSD8(instruction) => "HashPSD8",
            Instruction::HashSha3_256(instruction) => "HashSha3_256",
            Instruction::HashSha3_384(instruction) => "HashSha3_384",
            Instruction::HashSha3_512(instruction) => "HashSha3_512",
            Instruction::HashManyPSD2(instruction) => "HashManyPSD2",
            Instruction::HashManyPSD4(instruction) => "HashManyPSD4",
            Instruction::HashManyPSD8(instruction) => "HashManyPSD8",
            Instruction::Inv(instruction) => "Inv",
            Instruction::IsEq(instruction) => "IsEq",
            Instruction::IsNeq(instruction) => "IsNeq",
            Instruction::LessThan(instruction) => "LessThan",
            Instruction::LessThanOrEqual(instruction) => "LessThanOrEqual",
            Instruction::Modulo(instruction) => "Modulo",
            Instruction::Mul(instruction) => "Mul",
            Instruction::MulWrapped(instruction) => "MulWrapped",
            ...
            Instruction::PowWrapped(instruction) => "PowWrapped",
            Instruction::Rem(instruction) => "Rem",
            Instruction::RemWrapped(instruction) => "RemWrapped",
            Instruction::Shl(instruction) => "Shl",
            Instruction::ShlWrapped(instruction) => "ShlWrapped",
            Instruction::Shr(instruction) => "Shr",
            Instruction::ShrWrapped(instruction) => "ShrWrapped",
            Instruction::SignVerify(instruction) => "SignVerify",
            Instruction::Square(instruction) => "Square",
            Instruction::SquareRoot(instruction) => "SquareRoot",
            Instruction::Sub(instruction) => "Sub",
            Instruction::SubWrapped(instruction) => "SubWrapped",
            Instruction::Ternary(instruction) => "Ternary",
            Instruction::Xor(instruction) => "Xor",
        };

        let j_value = match self {
            Instruction::Abs(instruction) => instruction.to_json(),
            Instruction::AbsWrapped(instruction) => instruction.to_json(),
            Instruction::Add(instruction) => instruction.to_json(),
            Instruction::AddWrapped(instruction) => instruction.to_json(),
            Instruction::And(instruction) => instruction.to_json(),
            Instruction::AssertEq(instruction) => instruction.to_json(),
            Instruction::AssertNeq(instruction) => instruction.to_json(),
            Instruction::Async(instruction) => instruction.to_json(),
            Instruction::Call(instruction) => instruction.to_json(),
            Instruction::Cast(instruction) => instruction.to_json(),
            Instruction::CastLossy(instruction) => instruction.to_json(),
            Instruction::CommitBHP256(instruction) => instruction.to_json(),
            Instruction::CommitBHP512(instruction) => instruction.to_json(),
            Instruction::CommitBHP768(instruction) => instruction.to_json(),
            Instruction::CommitBHP1024(instruction) => instruction.to_json(),
            Instruction::CommitPED64(instruction) => instruction.to_json(),
            Instruction::CommitPED128(instruction) => instruction.to_json(),
            Instruction::Div(instruction) => instruction.to_json(),
            Instruction::DivWrapped(instruction) => instruction.to_json(),
            Instruction::Double(instruction) => instruction.to_json(),
            Instruction::GreaterThan(instruction) => instruction.to_json(),
            Instruction::GreaterThanOrEqual(instruction) => instruction.to_json(),
            Instruction::HashBHP256(instruction) => instruction.to_json(),
            Instruction::HashBHP512(instruction) => instruction.to_json(),
            Instruction::HashBHP768(instruction) => instruction.to_json(),
            Instruction::HashBHP1024(instruction) => instruction.to_json(),
            Instruction::HashKeccak256(instruction) => instruction.to_json(),
            Instruction::HashKeccak384(instruction) => instruction.to_json(),
            Instruction::HashKeccak512(instruction) => instruction.to_json(),
            Instruction::HashPED64(instruction) => instruction.to_json(),
            Instruction::HashPED128(instruction) => instruction.to_json(),
            Instruction::HashPSD2(instruction) => instruction.to_json(),
            Instruction::HashPSD4(instruction) => instruction.to_json(),
            Instruction::HashPSD8(instruction) => instruction.to_json(),
            Instruction::HashSha3_256(instruction) => instruction.to_json(),
            Instruction::HashSha3_384(instruction) => instruction.to_json(),
            Instruction::HashSha3_512(instruction) => instruction.to_json(),
            Instruction::HashManyPSD2(instruction) => instruction.to_json(),
            Instruction::HashManyPSD4(instruction) => instruction.to_json(),
            Instruction::HashManyPSD8(instruction) => instruction.to_json(),
            Instruction::Inv(instruction) => instruction.to_json(),
            Instruction::IsEq(instruction) => instruction.to_json(),
            Instruction::IsNeq(instruction) => instruction.to_json(),
            Instruction::LessThan(instruction) => instruction.to_json(),
            Instruction::LessThanOrEqual(instruction) => instruction.to_json(),
            Instruction::Modulo(instruction) => instruction.to_json(),
            Instruction::Mul(instruction) => instruction.to_json(),
            Instruction::MulWrapped(instruction) => instruction.to_json(),
            Instruction::Nand(instruction) => instruction.to_json(),
            Instruction::Neg(instruction) => instruction.to_json(),
            Instruction::Nor(instruction) => instruction.to_json(),
            Instruction::Not(instruction) => instruction.to_json(),
            Instruction::Or(instruction) => instruction.to_json(),
            Instruction::Pow(instruction) => instruction.to_json(),
            Instruction::PowWrapped(instruction) => instruction.to_json(),
            Instruction::Rem(instruction) => instruction.to_json(),
            Instruction::RemWrapped(instruction) => instruction.to_json(),
            Instruction::Shl(instruction) => instruction.to_json(),
            Instruction::ShlWrapped(instruction) => instruction.to_json(),
            Instruction::Shr(instruction) => instruction.to_json(),
            Instruction::ShrWrapped(instruction) => instruction.to_json(),
            Instruction::SignVerify(instruction) => instruction.to_json(),
            Instruction::Square(instruction) => instruction.to_json(),
            Instruction::SquareRoot(instruction) => instruction.to_json(),
            Instruction::Sub(instruction) => instruction.to_json(),
            Instruction::SubWrapped(instruction) => instruction.to_json(),
            Instruction::Ternary(instruction) => instruction.to_json(),
            Instruction::Xor(instruction) => instruction.to_json(),
        };
